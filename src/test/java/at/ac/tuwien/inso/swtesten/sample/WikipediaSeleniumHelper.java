...
public class WikipediaSeleniumHelper {
	...
	public void selectLanguage() {
		driver.get(baseUrl);
		driver.findElement(
				By.cssSelector("div.central-featured-lang.lang5 > a.link-box > strong"))
				.click();
	}
	...
	public void assertStartPageText(String arg1) {
		assertEquals(
				arg1,
				driver.findElement(
						By.xpath("//div[@id='hauptseite-willkommen']/h2/span"))
						.getText());
	}
	...
	public void assertThatArticleNotExists(String articleName) {
		WebElement element = driver.findElement(By
				.className("mw-search-createlink"));
		assertEquals(
				"Der Artikel „"
						+ articleName
						+ "“ existiert in der deutschsprachigen Wikipedia nicht. Du kannst den Artikel erstellen (Anleitung).\n"
						+ "Wenn dir die folgenden Suchergebnisse nicht weiterhelfen, wende dich bitte an die Suchhilfe oder suche nach „"
						+ articleName + "“ in anderssprachigen Wikipedias.",
				element.getText());
	}
}
